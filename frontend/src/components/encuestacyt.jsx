  ...
  return (
    <div className="page">
      ...
      <header className="header">
        <h1 className="title">Encuesta Vocacional STEM</h1>
        <p className="subtitle">
          Descubre tu afinidad con áreas de <strong>ciencia y tecnología</strong>.
        </p>
      </header>
        ...
        <main className="container">
          <section className="card card--result">
            ...
            <div className="tips">
              ...
              <ul>
                <li>
                  <strong>Desarrollo de Software:</strong> proyectos web/mobile, patrones de diseño, pruebas.
                </li>
                <li>
                  <strong>Datos e IA:</strong> estadística, Python, scikit-learn, visualización.
                </li>
                <li>
                  <strong>Ciberseguridad:</strong> hardening, OWASP, análisis de riesgos, SOC.
                </li>
                <li>
                  <strong>Cloud/Redes:</strong> Linux, contenedores, IaC, monitoreo.
                </li>
                <li>
                  <strong>Robótica:</strong> Arduino, Raspberry Pi, CAD, control.
                </li>
                <li>
                  <strong>Ciencia/I+D:</strong> método científico, laboratorio, revisión por pares.
                </li>
              </ul>
            </div>
