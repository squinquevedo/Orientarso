  ...
  return (
    <>
            ...
            <div className={`dropdown ${isMenuOpen ? 'open' : ''}`}>
              ...
              {isMenuOpen && (
                <div className="dropdown-menu">
                  ...
                  <a href="#areas-vocacionales" onClick={closeMenu}>Areas Vocacionales</a>
                </div>
              )}
            </div>
      ...
      <section className="benefits">
        ...
        <div className="cards">
          <div className="card" role="button" tabIndex={0} onClick={() => openModal(imgAutoconocimiento)} onKeyDown={(e) => { if (e.key === 'Enter') openModal(imgAutoconocimiento); }}>
            <img
          ...
          <div className="card" role="button" tabIndex={0} onClick={() => openModal(imgResultados)} onKeyDown={(e) => { if (e.key === 'Enter') openModal(imgResultados); }}>
            <img
              className="card-image"
              src={imgResultados}
          ...
          <div className="card" role="button" tabIndex={0} onClick={() => openModal(imgExplora)} onKeyDown={(e) => { if (e.key === 'Enter') openModal(imgExplora); }}>
            <img
              className="card-image"
              src={imgExplora}
      ...
      <section className="areas" id="areas-vocacionales">
        <h2>Areas Vocacionales</h2>
        <div className="areas-container">
          <div className="area">Tecnologia</div>
      ...
      <footer>
        <p>� 2026 Orientarso | Plataforma de Orientaci�n Vocacional</p>
      </footer>
    </>
  );
}
